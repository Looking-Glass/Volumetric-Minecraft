...
void main(){
    ...
    _SO[0] = vec4(0.9, 0.9, 0.01, 0.0);
    _SO[1] = vec4(0.9, 0.9, 0.01, 0.0);
    _SO[2] = vec4(0.9, 0.9, 0.01, 0.0);
    _SO[3] = vec4(0.9, 0.9, 0.01, 0.0);
    _SO[4] = vec4(0.9, 0.9, 0.01, 0.0);
    _SO[5] = vec4(0.9, 0.9, 0.01, 0.0);
    _SO[6] = vec4(0.9, 0.9, 0.01, 0.0);
    _SO[7] = vec4(0.9, 0.9, 0.01, 0.0);
    _SO[8] = vec4(0.9, 0.9, 0.01, 0.0);
    _SO[9] = vec4(0.9, 0.9, 0.01, 0.0);
